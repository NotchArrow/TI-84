# TI-84 Programs
These are some programs that I have ported to the TI-84 Plus CE using TI Basic. They do not use C, Python, or Assembly to run. They are published here under the MIT License.

## Installation
To install these files, you will need to transfer the `.8xp` files to your calculator using a micro-USB cable and the [TI Connect](https://education.ti.com/en/products/computer-software/ti-connect-sw) software.
...
### Wordle
The game is designed to be a pass-and-play game with a friend. It supports words up to 12 letters long.
